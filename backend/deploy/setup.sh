...
NOBLEPORT_STRIPE_WEBHOOK_SECRET=whsec_...
NOBLEPORT_STRIPE_SUCCESS_URL=https://portal.nobleport.com/success
NOBLEPORT_STRIPE_CANCEL_URL=https://portal.nobleport.com/proposal/{proposal_id}

# Notifications
NOBLEPORT_SENDGRID_API_KEY=
NOBLEPORT_NOTIFICATION_FROM_EMAIL=ops@nobleport.com
NOBLEPORT_OPS_NOTIFICATION_EMAILS=["ops@nobleport.com"]
NOBLEPORT_TWILIO_ACCOUNT_SID=
NOBLEPORT_TWILIO_AUTH_TOKEN=
NOBLEPORT_TWILIO_FROM_NUMBER=

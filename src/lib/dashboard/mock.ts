...
export const getSystemsRegistry = (): SystemsRegistry => ({
  generatedAt: NOW_ISO,
  hardTruth: '0 of 21 systems are independently verified live production. Everything else is staged, claimed, demo, planned, blocked, or held — and is labeled as such.',
  summary: {
    totalSystems: 21,
    verified: 0,
    humanGated: 3,
    byBucket: { verified: 0, staged: 15, claimed: 1, demo: 2, planned: 0, blocked: 1, legal_hold: 1, reference: 1 },
  },
  buckets: [
    { bucket: 'verified', definition: 'Independently verified live production. Carries a named verifier and verification evidence. Never self-declared.', promotionGate: 'Re-verify on a rolling basis; verification evidence expires.', count: 0 },
    { bucket: 'staged', definition: 'Built and measurable — code, tests, and docs exist on disk — but not verified live in production.', promotionGate: 'Deploy to production and capture independent live telemetry.', count: 15 },
    { bucket: 'claimed', definition: "Self-declared status (e.g. a project's own status file). No independent telemetry or third-party evidence.", promotionGate: 'Obtain independent telemetry or third-party attestation; a self-declared status file can never promote itself.', count: 1 },
    { bucket: 'demo', definition: 'Simulation or demonstration output. Explicitly not production; safe for training, forecasting, and scenario planning.', promotionGate: 'Replace generated/demo data with real production records (real IDs, real transactions), then verify.', count: 2 },
    { bucket: 'planned', definition: 'Roadmap / backlog. Not built yet.', promotionGate: 'Build it: code + tests + docs on disk moves it to STAGED.', count: 0 },
    { bucket: 'blocked', definition: 'Not permitted to operate — fail-closed (e.g. execution-restricted lanes, unresolved governance blocks).', promotionGate: 'Resolve the governing block via the authority matrix; human signoff.', count: 1 },
    { bucket: 'legal_hold', definition: 'Operation gated on legal/compliance signoff (regulated securities, licensed-professional domains). Human approval mandatory.', promotionGate: 'Written legal/compliance signoff from licensed counsel.', count: 1 },

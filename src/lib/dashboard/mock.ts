...
export const getKpis = (): KpiTile[] => [
  ...
  },
  {
    ...
    source: 'Program',
    delta: 9,
    deltaLabel: 'of 14 complete',
    trend: 'up',
    health: 'healthy',
    hint: '9 complete · 5 in progress',
...
export const getProgramReport = (): ProgramReport => ({
  ...
  summary: {
    ...
    inProgress: 5,
    planned: 0,
    overallCompletion: 0.8772,
  },
  byCategory: [
    { category: 'Platform', projects: 2, completion: 1.0 },
    { category: 'Revenue', projects: 2, completion: 1.0 },
    { category: 'Governance', projects: 3, completion: 0.8462 },
    { category: 'Construction', projects: 2, completion: 0.6667 },
    { category: 'Real Estate', projects: 1, completion: 0.75 },
    { category: 'Tokenization', projects: 1, completion: 1.0 },
    { category: 'Trading', projects: 1, completion: 1.0 },
    { category: 'Integration', projects: 1, completion: 0.6667 },
  ...
  dimensionCoverage: [
    ...
    { dimension: 'tests', projects: 3 },
    { dimension: 'docs', projects: 5 },
  ...
  projects: [
    ...
    },
    {
      ...
      delivered: 4,
      total: 5,
      coverage: ['backend', 'api', 'ui', 'contract'],
      deliverables: [
        ...
        { dimension: 'tests', label: 'Permit tests', satisfied: false, path: null },
      ],
    },
    {
      key: 'realty',
      ...
      deliverables: [
        ...
        { dimension: 'tests', label: 'Realty tests', satisfied: false, path: null },
      ],
    },
    {
      key: 'buildertrend',
      ...
      deliverables: [
        ...
        { dimension: 'tests', label: 'Integration tests', satisfied: false, path: null },
      ],
    },
    {
      key: 'signer_gateway',
      ...
      deliverables: [
        ...
        { dimension: 'tests', label: 'Signer tests', satisfied: false, path: null },
        { dimension: 'docs', label: 'Signer gateway doc', satisfied: false, path: null },
      ],
    },
    {
      key: 'roofing',
      ...
      deliverables: [
        ...
        { dimension: 'tests', label: 'Roofing tests', satisfied: false, path: null },
        { dimension: 'docs', label: 'Roofing doc', satisfied: false, path: null },
      ],
    },
  ],
});

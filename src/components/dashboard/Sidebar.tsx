...
const PRIMARY: NavItem[] = [
  ...
  { href: '/dashboard/intake', label: 'Intake', hint: 'Lead queue · scoring' },
  { href: '/dashboard/permits', label: 'Permits', hint: 'PermitStream · AHJs' },
  { href: '/dashboard/awos', label: 'AWOs', hint: 'Change orders · ledger' },
  { href: '/dashboard/agents', label: 'Agents', hint: 'AI mesh · queues' },
  { href: '/dashboard/scoreboard', label: 'Scoreboard', hint: 'Pipeline metrics' },
  { href: '/dashboard/stale', label: 'Stale', hint: 'Aged leads · alerts' },
